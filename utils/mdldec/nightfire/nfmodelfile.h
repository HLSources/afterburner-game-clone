...
typedef struct
{
	...
	mdlv14_trianglemap_t* triangleMaps;

	size_t vertexCount;
	mdlv14_pos_scale_t* vertices;

	size_t normalCount;
	mdlv14_pos_scale_t* normals;

	size_t texCoOrdCount;
	mdlv14_texcoord_t* texCoOrds;

	size_t blendingScaleCount;
	mdlv14_blendingscale_t* blendingScales;

	size_t blendCount;
	mdlv14_blending_t* blends;

	size_t boneFixUpCount;
	mdlv14_bonefixup_t* boneFixUps;
...
mdlv14_bonefixup_t* NF_ModelFile_GetBoneFixUp(nfmodelfile_t* modelFile, size_t index);
