...
static constexpr const char* const CarpetDecals[] =
{
	"{d_carpet_01",
	"{d_carpet_02",
	"{d_carpet_03",
...
static constexpr const char* const DirtDecals[] =
{
	"{d_dirt_01",
	"{d_dirt_02",
	"{d_dirt_03",
...
static constexpr const char* const GrassDecals[] =
{
	"{d_grass_01",
	"{d_grass_02",
	"{d_grass_03",
...
static constexpr const char* const MetalDecals[] =
{
	"{d_metal_01",
	"{d_metal_02",
	"{d_metal_03",
...
static constexpr const char* const GoldDecals[] =
{
	"{d_gold_01",
	"{d_gold_02",
	"{d_gold_03",
...
static constexpr const char* const SandDecals[] =
{
	"{d_sand_01",
	"{d_sand_02",
	"{d_sand_03",
...
static constexpr const char* const ScorchDecals[] =
{
	"{d_scorch_01",
	"{d_scorch_02",
	"{d_scorch_03",
...
static constexpr const char* const SnowDecals[] =
{
	"{d_snow_01",
	"{d_snow_02",
	"{d_snow_03",
...
static constexpr const char* const StoneDecals[] =
{
	"{d_stone_01",
	"{d_stone_01",
	"{d_stone_01",
...
static constexpr const char* const WoodDecals[] =
{
	"{d_wood_01",
	"{d_wood_02",
	"{d_wood_03",
